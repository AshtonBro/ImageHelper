...
using AshtonBro.MetroApplication.Common;
using AshtonBro.MetroApplication.DataModel;
...
namespace AshtonBro.MetroApplication
{
    /// <summary>
    ...
    public sealed partial class App
    {
        ...
        protected override void OnSearchActivated(SearchActivatedEventArgs args)
        {
            ...
            {
                SearchResul.Activate(args.QueryText, args.PreviousExecutionState);
            }
        }
    }
